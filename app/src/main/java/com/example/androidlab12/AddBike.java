...
public class AddBike extends AppCompatActivity {
    String Storage_Path = "Bikes_images/";
    String Database_Path = "Bikes";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new android.app.ProgressDialog(AddBike.this);
    ...
    */
    public void uploadFile() {
        ...
        if (filePath != null) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            sRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri downloadPhotoUrl) {
                                    Bike bike = new Bike(edName.getText().toString().trim(),
                                            Integer.parseInt(edPrice.getText().toString().trim()),
                                            downloadPhotoUrl.toString());

                                    //adding an upload to firebase database
                                    String uploadId = mDatabase.push().getKey();
                                    mDatabase.child(uploadId).setValue(bike);
                                }
                            });
            ...
            android.widget.Toast.makeText(AddBike.this, "Please Select Image or Add Image Name", android.widget.Toast.LENGTH_LONG).show();
        }
    }
}